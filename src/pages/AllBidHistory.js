...
//   const [gameNameList, setGameNameList] = useState([]);
//   const [selectedGameName, setSelectedGameName] = useState("");
//   // New state for game type filter
//   const [selectedGameType, setSelectedGameType] = useState("");
//   // List of game types (based on handleShareOnWhatsApp)
//   const gameTypeList = [
//     "singleDigits",
//       "jodi",
//       "halfSangamA",
...
//           market: "Main Market",
//           gameName: selectedGameName,
//           ...(selectedGameType && { gameType: selectedGameType }), // Add gameType filter
//         });
//         filteredData = response.data?.bids || [];
//       } else {
//         let queryParams = `/api/starlinebid/getallbid?`;
...
//         if (selectedMarket) queryParams += `market=${encodeURIComponent(selectedMarket)}&`;
//         if (selectedGameName) queryParams += `gamename=${encodeURIComponent(selectedGameName)}&`;
//         if (selectedGameType) queryParams += `gameType=${encodeURIComponent(selectedGameType)}&`; // Add gameType to query
//         queryParams = queryParams.replace(/[?&]$/, "");
...
//               (!selectedMarket || item.market === selectedMarket) &&
//               (!selectedGameName || item.gamename === selectedGameName) &&
//               (!selectedGameType || item.gameType === selectedGameType) // Filter by gameType
//             );
//           }) || [];
//       }
//       setBidHistoryData(filteredData);
...
//       fetchBidHistory();
//     }
//   }, [selectedDate, selectedGameType]); // Add selectedGameType to dependencies
...
//   // Updated filtering logic to include game type
//   const filteredData = bidHistoryData.filter((bid) =>
//     Object.values(bid).some((value) =>
//       value?.toString().toLowerCase().includes(search.toLowerCase())
